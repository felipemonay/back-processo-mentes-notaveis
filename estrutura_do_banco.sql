...
--
-- Database: `mestes_notaveis`
--
CREATE DATABASE IF NOT EXISTS `mentes_notaveis`;
USE `mentes_notaveis`;
...
--
-- Criando e alimentando tabela de cidades e estados
--
...
ALTER TABLE `enderecos` 
  ADD CONSTRAINT `fk_usuario_enderecos` FOREIGN KEY ( `idUsuario` ) REFERENCES `usuarios` ( `id` ) ;

ALTER TABLE `enderecos` 
  ADD CONSTRAINT `fk_cidade_enderecos` FOREIGN KEY ( `idCidade` ) REFERENCES `cidades` ( `id` ) ;

ALTER TABLE `enderecos` 
  ADD CONSTRAINT `fk_estado_enderecos` FOREIGN KEY ( `idEstado` ) REFERENCES `estados` ( `id` ) ;